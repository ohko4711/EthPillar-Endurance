...
linux_install_installer() {
    ...
    git clone -b main https://github.com/ohko4711/EthPillar-Endurance.git ~/git/ethpillar/ 2> /dev/null || (cd ~/git/ethpillar && git fetch origin main && git checkout main && git pull)
