...
linux_install_validator-install() {
    ...
    git clone https://github.com/ohko4711/EthPillar-Endurance.git ~/git/ethpillar 2> /dev/null || (cd ~/git/ethpillar ; git fetch origin main ; git checkout main ; git pull)
    ohai "Installing validator-install"
    $python ~/git/ethpillar/deploy-nimbus-reth.py
...
╚═╝╚═╝  ╚═══╝╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚══════╝                
                                   ...
                                   - coincashew.com
    """
    ohai "This script will install a Nimbus-Reth Ethereum node:"
